...
import { ComponentMap } from "../agent-uis/index.js";
import weather from "./ui.js";
...
const ui = typedUi<typeof ComponentMap>(_config);
...
ui.push({ name: "weather", props: { city: "New York" } }, { message:response });
console.log("ui", ui);
  /**
